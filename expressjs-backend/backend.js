...
// add a new user to the list of users. First 'write' operation
/*
const express = require('express'); //import express module 
const app = express(); //create instance of Express 
const port = 5000; //define a port number we'll use to listen to incoming HTTP request
...
app.delete('/users/:id', (req,res)=>
{
	...
	let deleteRes = deleteUser(deleteID);
	if(deleteRes === undefined || deleteRes.length == 0)
...
{
	return users['user list'].filter((user) => user['id'] !== id);
}
